...
street_id_dict = { "Adelsbredde": "241D7097",
...
def get_dates_as_json(street, number):
    # Load the trashtypes
    try:
    ...
    if (street_code != None and trash_types_json != None):
        try:
        ...
        for date_item in dates_json:
            date_item.update({"trashType": get_name_for_id(date_item.get("trashType"), trash_types_json)})
